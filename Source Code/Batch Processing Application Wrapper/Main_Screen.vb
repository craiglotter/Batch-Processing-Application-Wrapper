...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents mainapptoruntxt As System.Windows.Forms.TextBox
    ...
    Friend WithEvents inputtextfiletxt As System.Windows.Forms.TextBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.inputtextfiletxt = New System.Windows.Forms.TextBox
        Me.Label14 = New System.Windows.Forms.Label
        Me.CheckBox1 = New System.Windows.Forms.CheckBox
        Me.Label13 = New System.Windows.Forms.Label
        Me.mainapptoruntxt = New System.Windows.Forms.TextBox
        ...
        Me.Panel1.Controls.Add(Me.inputtextfiletxt)
        Me.Panel1.Controls.Add(Me.Label14)
        Me.Panel1.Controls.Add(Me.CheckBox1)
        Me.Panel1.Controls.Add(Me.Label13)
        Me.Panel1.Controls.Add(Me.mainapptoruntxt)
        ...
        'Label16
        '
        Me.Label16.Location = New System.Drawing.Point(144, 40)
        ...
        'inputtextfiletxt
        '
        Me.inputtextfiletxt.BackColor = System.Drawing.Color.Azure
        Me.inputtextfiletxt.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.inputtextfiletxt.ForeColor = System.Drawing.Color.Black
        Me.inputtextfiletxt.Location = New System.Drawing.Point(32, 64)
        Me.inputtextfiletxt.Name = "inputtextfiletxt"
        Me.inputtextfiletxt.ReadOnly = True
        Me.inputtextfiletxt.Size = New System.Drawing.Size(248, 20)
        Me.inputtextfiletxt.TabIndex = 59
        Me.inputtextfiletxt.Text = ""
        '
        'Label14
        '
        ...
        Me.Label14.Text = "INPUT TEXT FILE"
        ...
        Me.CheckBox1.Location = New System.Drawing.Point(256, 40)
        ...
        Me.Label13.Text = "COMMAND LINE EXECUTABLE TO WRAP"
        Me.Label13.TextAlign = System.Drawing.ContentAlignment.BottomLeft
        '
        'mainapptoruntxt
        '
        Me.mainapptoruntxt.BackColor = System.Drawing.Color.Azure
        Me.mainapptoruntxt.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.mainapptoruntxt.ForeColor = System.Drawing.Color.Black
        Me.mainapptoruntxt.Location = New System.Drawing.Point(32, 104)
        Me.mainapptoruntxt.Name = "mainapptoruntxt"
        Me.mainapptoruntxt.Size = New System.Drawing.Size(312, 20)
        Me.mainapptoruntxt.TabIndex = 55
        Me.mainapptoruntxt.Text = "Example.exe arg1 #inputtext# arg3"
        '
        'Button3
        '
        ...
        Me.Button3.Text = "Begin Operation"
        '
        'Button1
        '
        ...
        Me.filefoldertxt.Location = New System.Drawing.Point(32, 16)
        ...
        Me.Label24.Location = New System.Drawing.Point(32, 8)
        ...
        Me.Label9.Text = "BUILD 20060224.1"
        ...
        Me.Label4.Size = New System.Drawing.Size(264, 48)
        Me.Label4.TabIndex = 60
        Me.Label4.Text = "Select your desired process input type, enter the command line to wrap and specif" & _
        "y the variable argument by using the #inputtext# reserved word."
        ...
        Me.Text = "Batch Processing Application Wrapper"
...
#End Region
    ...
    Private mainapptorun As String
    Private filetoreplacewith As String
    Private inputtextfile As String
    ...
    Private Sub Error_Handler(ByVal ex As Exception, Optional ByVal identifier_msg As String = "")
        ...
        Catch exc As Exception
            MsgBox("An error occurred in Batch Processing Application Wrapper's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
    ...
    Public Sub Load_Registry_Values()
        Try
            ...
            For Each str In keys
                If str.Equals("Software\Batch Processing Application Wrapper") = True Then
                    keyflag1 = True
                    Exit For
                End If
            Next str
            ...
            If keyflag1 = False Then
                oReg.CreateSubKey("Software\Batch Processing Application Wrapper")
            End If

            keyflag1 = False

            Dim oKey As RegistryKey = oReg.OpenSubKey("Software\Batch Processing Application Wrapper", True)
            ...
            str = oKey.GetValue("mainapptorun")
            If Not IsNothing(str) And Not (str = "") Then
                mainapptorun = str
            Else
                configflag = True
                oKey.SetValue("mainapptorun", ("Example.exe arg1 #inputtext# arg3"))
                mainapptorun = ("Example.exe arg1 #inputtext# arg3")
            End If
            mainapptoruntxt.Text = mainapptorun

            str = oKey.GetValue("inputtextfile")
            If Not IsNothing(str) And Not (str = "") Then
                inputtextfile = str
            Else
                configflag = True
                oKey.SetValue("inputtextfile", "")
                inputtextfile = ""
            End If
            inputtextfiletxt.Text = inputtextfile
    ...
    Private Sub Save_Registry_Values()
        Try
            ...
            oKey.SetValue("mainapptorun", mainapptoruntxt.Text)
            oKey.SetValue("inputtextfile", inputtextfiletxt.Text)
    ...
    Private Sub run_worker()
        ...
        Worker1.mainapptorun = mainapptoruntxt.Text.Trim.ToLower
        Worker1.inputtextfile = inputtextfiletxt.Text
    ...
    Private Sub force_check()
        Try
            ...
            If currently_working = False Then
                If ((Not inputtextfiletxt.Text = "") Or (Not filefoldertxt.Text = "")) And (Not mainapptoruntxt.Text = "") Then
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            If Not inputtextfiletxt.Text = "" Then
                OpenFileDialog1.FileName = inputtextfiletxt.Text
            End If
            Dim result As DialogResult = OpenFileDialog1.ShowDialog()
            If Not result = DialogResult.Cancel Then
                inputtextfiletxt.Text = OpenFileDialog1.FileName
                inputtextfile = OpenFileDialog1.FileName
            End If
    ...
    Private Sub inputtextfiletxt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles inputtextfiletxt.TextChanged
        If inputtextfiletxt.Text.Length > 0 Then
