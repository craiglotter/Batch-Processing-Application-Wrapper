...
Public Class Worker
    ...
    Public mainapptorun As String = ""
    Public inputtextfile As String = ""
        ...
        Try
            ...
            Try
                If FolderWalkChosen = True Then
                    ...
                    dir = Nothing
                Else
                    Dim fir As FileInfo = New FileInfo(inputtextfile)
                    If fir.Exists = True Then
                        TextFileWalker(inputtextfile)
                    End If
                    fir = Nothing
                End If
            Catch ex As Exception
            ...
            If finfo.Exists = True Then
                ...
                While filereader.Peek > -1
                    ...
                    If (Not lineread Is Nothing) And (Not lineread = "") Then
                        apptorun = mainapptorun.Replace("#inputtext#", lineread)
        ...
        Try
            ...
            For Each fileName In fileEntries
                Try
                    ...
                    'If finfo.Name.ToLower = mainapptorun Then
                    ...
                    apptorun = mainapptorun.Replace("#inputtext#", finfo.FullName)
                    Log_Handler("Action Taken: " & apptorun)
                    result = ApplicationLauncher(apptorun)
                    filecounter = filecounter + 1
                    'End If
